  ...
  return (
    <View style={styles.background}>
      ...
      >
        ...
        {
          isUserLoggedIn && loading ? <ActivityIndicator size='large' color='grey'/> : <View style={styles.buttonContainer}>
            <MenuButton 
        ...
        {
          !isUserLoggedIn && !loading && <View style={styles.buttonContainer}>
